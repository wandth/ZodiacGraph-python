...
namespace zodiac
{
	...
	EdgeGroup::EdgeGroup(Scene *scene,
	                     ...
	                     EdgeGroupPair *pair)
			: QObject(nullptr), EdgeGroupInterface(), m_scene(scene), m_fromNode(fromNode), m_toNode(toNode), m_pair(pair),
			  m_edges(QSet<PlugEdge *>()), m_straightEdge(nullptr), m_bentEdgesCount(0)
	{
