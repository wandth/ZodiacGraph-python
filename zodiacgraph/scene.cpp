...
namespace zodiac
{
	...
	Scene::Scene(QObject *parent)
			: QGraphicsScene(parent), m_drawEdge(nullptr), m_nodes(QSet<Node *>()), m_edges(QHash<QPair<Plug *, Plug *>, PlugEdge *>()),
			  m_edgeGroups(QHash<uint, EdgeGroup *>()), m_edgeGroupPairs(QSet<EdgeGroupPair *>())
	{
